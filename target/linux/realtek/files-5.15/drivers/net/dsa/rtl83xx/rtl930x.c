...
#define _RTL930X_LED_SET_CTRL_LED_MASK                          GENMASK(16, 0)
...
irqreturn_t rtl930x_switch_irq(int irq, void *dev_id)
{
	...
	if (ports) {
		...
		if (irq_retry-- == 0)
			sw_w32(0, RTL930X_IMR_SERDES_LINK_FAULT_REG);
	}
...
int rtl930x_write_phy(u32 port, u32 page, u32 reg, u32 val)
{
	...
	sw_w32(FIELD_PREP(RTL930X_SMI_ACCESS_PHY_CTRL_REG_ADDR, reg) |
	       ...
	       FIELD_PREP(RTL930X_SMI_ACCESS_PHY_CTRL_PARK_PAGE, RTL930X_SMI_ACCESS_PHY_CTRL_PARK_PAGE_NO_PARK) |
...
int rtl930x_read_phy(u32 port, u32 page, u32 reg, u32 *val)
{
	...
	sw_w32(FIELD_PREP(RTL930X_SMI_PHY_DATA_CTRL_PORT_ID, port),
	       RTL930X_SMI_PHY_DATA_CTRL_REG);
...
int rtl930x_write_mmd_phy(u32 port, u32 devnum, u32 regnum, u32 val)
{
	...
	sw_w32((sw_r32(RTL930X_SMI_ACCESS_PHY_CTRL_REG) & RTL930X_SMI_ACCESS_PHY_CTRL_PARK_PAGE) |
	       RTL930X_SMI_ACCESS_PHY_CTRL_RWOP |
...
static int rtl930x_route_lookup_hw(struct rtl83xx_route *rt)
{
	...
	if ((rt->attr.type == RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV4MC) ||
	    (rt->attr.type == RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE_IPV6MC))
		return -EOPNOTSUPP;

	/* Set entry type being searched, all other fields are 0 */
	sw_w32(RTL930X_L3_HW_LU_KEY_CTRL_ROUTE_TYPE(rt->attr.type), RTL930X_L3_HW_LU_KEY_CTRL);
